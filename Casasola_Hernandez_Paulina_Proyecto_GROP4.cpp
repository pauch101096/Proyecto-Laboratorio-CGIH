...
int main()
{
	...
	Model Carroseria((char*)"Models/casa/home.obj");
	...
	// Diffuse map
	image = stbi_load("images/pasto.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR_MIPMAP_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST_MIPMAP_NEAREST);
	image = stbi_load("images/container2.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
